...
public class TraitManager : MonoBehaviour
{
    ...
    private static readonly Dictionary<int, TraitInfo> traits = new Dictionary<int, TraitInfo>
    {
        ...
        { 2, new TraitInfo { Name = "Big", Cost = 2, Type = typeof(Trait_Big), HexColor = "#783506" } },
        { 3, new TraitInfo { Name = "Fortified", Cost = 3, Type = typeof(Trait_Fortified), HexColor = "#4795d6" } },
        { 4, new TraitInfo { Name = "Fast", Cost = 2, Type = typeof(Trait_Fast), HexColor = "#fff700" } },
        { 5, new TraitInfo { Name = "Efficient Eater", Cost = 2, Type = typeof(Trait_EfficientEater), HexColor = "#228B22" } },
        { 6, new TraitInfo { Name = "Immortal", Cost = 4, Type = typeof(Trait_Immortal), HexColor = "#ffd700" } },
        { 7, new TraitInfo { Name = "Fertile", Cost = 2, Type = typeof(Trait_Fertile), HexColor = "#FF69B4" } },
        ...
        { 25, new TraitInfo { Name = "Burrowing", Cost = 2, Type = typeof(Trait_Burrower), HexColor = "#8B4513" } },
        ...
        { 31, new TraitInfo { Name = "Giant", Cost = 5, Type = typeof(Trait_Giant), HexColor = "#5A2D0C" } },
        { 32, new TraitInfo { Name = "Bioluminescent", Cost = 2, Type = typeof(Trait_Bioluminescent), HexColor = "#00FFFF" } },
        { 33, new TraitInfo { Name = "Loyal", Cost = 2, Type = typeof(Trait_Loyal), HexColor = "#FF1493" } }
    };
